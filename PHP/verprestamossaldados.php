...
if ($conexion)
{
	...
	$query = "SELECT idprestamos,idempleados,cantidad,date_format(fecha_pedido, '%W %D %M %Y'), date_format(fecha_pagado, '%W %D %M %Y') FROM prestamos WHERE MONTH(fecha_pedido)=".$mes." AND YEAR(fecha_pedido)=".$anio." AND fecha_pagado IS NOT NULL";
