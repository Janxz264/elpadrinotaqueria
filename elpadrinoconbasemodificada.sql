...
CREATE TABLE IF NOT EXISTS `asistencia` (
  ...
  `IDEMPLEADOS` int(11) NOT NULL DEFAULT '0',
  `FECHA` date DEFAULT NULL,
  PRIMARY KEY (`IDASISTENCIA`),
  KEY `FK_asistencia_empleados` (`IDEMPLEADOS`),
  CONSTRAINT `FK_asistencia_empleados` FOREIGN KEY (`IDEMPLEADOS`) REFERENCES `empleados` (`IDEMPLEADOS`)
...
-- Dumping structure for table elpadrino.empleados
CREATE TABLE IF NOT EXISTS `empleados` (
  `IDEMPLEADOS` int(11) NOT NULL AUTO_INCREMENT,
  `SALARIO` int(11) NOT NULL DEFAULT '0',
  `NOMBRE` varchar(160) DEFAULT NULL,
  `PATERNO` varchar(160) DEFAULT NULL,
  `MATERNO` varchar(160) DEFAULT NULL,
  `FECHA_INGRESO` date DEFAULT NULL,
  `FECHA_EGRESO` date DEFAULT NULL,
  PRIMARY KEY (`IDEMPLEADOS`)
) ENGINE=InnoDB AUTO_INCREMENT=3 DEFAULT CHARSET=utf8;

-- Dumping data for table elpadrino.empleados: ~0 rows (approximately)
DELETE FROM `empleados`;
/*!40000 ALTER TABLE `empleados` DISABLE KEYS */;
INSERT INTO `empleados` (`IDEMPLEADOS`, `SALARIO`, `NOMBRE`, `PATERNO`, `MATERNO`, `FECHA_INGRESO`, `FECHA_EGRESO`) VALUES
	(2, 2250, 'Germán', 'Díaz', 'Martínez', '2020-03-19', NULL);
...
INSERT INTO `inventario` (`IDINVENTARIO`, `FECHA`) VALUES
	(3, '2020-03-05'),
	(7, '2020-03-05'),
	(8, '2020-03-05'),
	(9, '2020-03-05'),
...
INSERT INTO `inventario_articulo` (`IDINVENTARIO`, `IDARTICULO`, `CANTIDAD`) VALUES
	(7, 2, 5),
	(8, 2, 2),
	(10, 3, 3),
	(10, 3, 2),
...
-- Dumping data for table elpadrino.mensajes: ~2 rows (approximately)
DELETE FROM `mensajes`;
/*!40000 ALTER TABLE `mensajes` DISABLE KEYS */;
INSERT INTO `mensajes` (`IDMENSAJES`, `IDUSUARIOS`, `TITULO`, `MENSAJE`, `FECHA_HORA`, `VISTO`) VALUES
	(1, 1, 'jaja', 'xxdxdxd', '2020-01-24 13:46:57', b'1'),
	(2, 1, 'jeje', 'ifgajioñwrgnañwgnorñegawrgaXDASDAAAAAADDDDDDDDDDDDDDDDDDDDDDDDDDDDDDD', '2020-01-24 14:05:12', b'1');
...
-- Dumping data for table elpadrino.notas: ~2 rows (approximately)
DELETE FROM `notas`;
/*!40000 ALTER TABLE `notas` DISABLE KEYS */;
INSERT INTO `notas` (`IDNOTAS`, `FECHA`, `EFECTIVO`, `TARJETA`) VALUES
	(1, '2019-12-07', 424, 0),
	(2, '2019-12-01', 250, 0),
	(3, '2020-01-08', 580, 250);
...
-- Dumping data for table elpadrino.notas_productos: ~6 rows (approximately)
...
CREATE TABLE IF NOT EXISTS `prestamos` (
  ...
  KEY `FK_prestamos_empleados` (`IDEMPLEADOS`),
  CONSTRAINT `FK_prestamos_empleados` FOREIGN KEY (`IDEMPLEADOS`) REFERENCES `empleados` (`IDEMPLEADOS`)
) ENGINE=InnoDB AUTO_INCREMENT=6 DEFAULT CHARSET=utf8;

-- Dumping data for table elpadrino.prestamos: ~0 rows (approximately)
DELETE FROM `prestamos`;
/*!40000 ALTER TABLE `prestamos` DISABLE KEYS */;
INSERT INTO `prestamos` (`IDPRESTAMOS`, `IDEMPLEADOS`, `CANTIDAD`, `FECHA_PEDIDO`, `FECHA_PAGADO`) VALUES
	(1, 2, 150, '2020-03-05', '2020-03-05'),
	(2, 2, 150, '2020-03-05', '2020-03-05'),
	(3, 2, 200, '2020-03-04', '2020-03-05'),
	(4, 2, 225, '2020-03-05', '2020-03-05'),
	(5, 2, 250, '2020-03-05', NULL);
